...
const playerContractAddressEVM = '0x5FbDB2315678afecb367f032d93F642f64180aa3'
function App() {
  ...
  const getContract = async () => {
    try {
      ...
      console.log(' 2accountFromMetamask', accountFromMetamask)
      const abi = playerAbi.abi
      const address = playerContractAddressEVM
      ...
      console.log('3userInfo', userInfo)
      setUserInfo(userInfo)
      // check if user exist on contract
      if (!userInfo) {
        console.log('555userInfo')
      }
      ...
      window.alert(
        'Contract is not deployed to the detected network Connect to the correct network and make sure to register!',
      )
    }
  }
